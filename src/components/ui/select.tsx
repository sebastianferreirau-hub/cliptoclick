...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex min-h-[48px] w-full items-center justify-between rounded-xl border-[1.5px] border-[var(--cc-border)] bg-[var(--cc-field-bg)] px-4 py-3.5 text-[var(--cc-text)] outline-none transition-all duration-150",
      ...
      "data-[placeholder]:text-[var(--cc-placeholder)]",
      "[&>span]:line-clamp-1",
      className,
    )}
    {...props}
